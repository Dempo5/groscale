...
export default function Uploads() {
  ...
  // NEW: show delimiter without await in JSX
  ...
  const parsePreview = async (f: File) => {
    ...
    setDetectedDelimiter(delim); // NEW

    let lines = text.split(/\r?\n/);
    // trim any trailing blank line so counts match
  ...
  useEffect(() => {
    ...
    const onKey = (e: KeyboardEvent) => {
      if (e.key === "Escape" && !wip) setOpen(false);
    };
              ...
              <div className="map">
                <div className="map-row">
                  ...
                  <Select
                    ...
                    placeholder="(optional if First+Last)"
                  />
                </div>
